...
window.OWL_STORY_DATA = {
  ...
  "characters": {
    ...
    "marta": { "name": "Marta Maus", "symbol": "MM", "color": "#e6b58a", "motif": [245, 294, 220] }
  },
  "giftChoices": [
  ...
  "chapters": [
    ...
    },
    {
      ...
      "lines": [
        { "speaker": "lumi", "text": "Die Mondwiese. Breite Bögen, klare Wege – das klingt machbar." },
        { "speaker": "fynn", "text": "Ava sagt: Der beste Weg ist der, auf dem du sicher zurückkommst." }
      ],
      "beats": [
        { "progress": 0.35, "speaker": "fynn", "text": "Du musst nicht die engste Lücke nehmen. Such dir deinen Bogen." },
        { "progress": 0.7, "speaker": "lumi", "text": "Route merken, Fund aufnehmen, sicher heim. Langsam verstehe ich die Prüfung." }
      ]
    },
    {
